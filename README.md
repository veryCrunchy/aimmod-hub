...
docker run -p 8080:8080 \
  ...
  -e AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_URL=https://github.com/ggml-org/llama.cpp/releases/download/b8532/llama-b8532-bin-win-cuda-12.4-x64.zip \
  -e AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_SHA256=<sha256> \
  -e AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_ARCHIVE_TYPE=zip \
  -e AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_EXTRA_URL=https://github.com/ggml-org/llama.cpp/releases/download/b8532/cudart-llama-bin-win-cuda-12.4-x64.zip \
  -e AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_EXTRA_SHA256=<sha256> \
  -e AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_EXTRA_ARCHIVE_TYPE=zip \
...
- `AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_EXTRA_URL` — optional companion runtime archive like CUDA DLL packs
- `AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_EXTRA_SHA256`
- `AIMMOD_HUB_LLM_RUNTIME_WINDOWS_X64_EXTRA_ARCHIVE_TYPE`
...
- `AIMMOD_HUB_LLM_RUNTIME_WINDOWS_ARM64_EXTRA_URL`
- `AIMMOD_HUB_LLM_RUNTIME_WINDOWS_ARM64_EXTRA_SHA256`
- `AIMMOD_HUB_LLM_RUNTIME_WINDOWS_ARM64_EXTRA_ARCHIVE_TYPE`
